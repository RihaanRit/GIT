...
def main():
   ...
   candle(-45,87.25)   
   flame_on_off()
   number_of_balloons = int(input("How many balloons would you like to draw?" ))
   for _ in range(number_of_balloons):
        color = input("Enter the color of the balloon: ")
        x = int(input("Enter the x-coordinate for the balloon: "))
        y = int(input("Enter the y-coordinate for the balloon: "))
        balloon(x,y,color)
   turtle.hideturtle()
